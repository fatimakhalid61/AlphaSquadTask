...
class Case_Studies_Inner extends Component {
    render() {
        return (
          ...
          <Label classs="text-gray-600 text-md">Kanban Software</Label>
          <Label classs="font-extrabold text-4xl">Trello x Weber</Label>
          <Label classs="text-gray-600 text-md">
          ...
          <div class="mt-8 grid grid-cols-2 gap-3 grid-flow-row ">
            <Label>Industry: Technology</Label>
            <Label>Since: 2018</Label>
            <Label>Use case: Developer operations</Label>
            <Label>Package: Enterprise+</Label>
          </div>
          <div class="mt-10 grid gap-3 grid-flow-row ">
          <Label classs="font-bold text-3xl" >
            The details
          </Label>
          <Label>
    ...
    There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.
          ...
          <Label classs="font-semibold text-gray-700">
    ...
    There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.
          ...
          <div class="text-white h-auto p-10 grid grid-flow-row  gap-4 clear-both bg-gradient-to-r from-purple-400 via-pink-500 to-red-500">
          <Label classs="font-medium text-lg">Get Webber for your organization</Label>
          <Label classs="text-sm">
          There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look.
          </Label>
          <div class="flex space-x-1 grid grid-flow-col gap-2">
          <ButtonReact class="transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110 place-self-center rounded-sm  text-blue-100 bg-white ">Start trial</ButtonReact>
          <ButtonReact class="transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110 place-self-center rounded-sm  text-white border-2 border-white bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 ">Contact sales</ButtonReact>
          </div>
          </div>
          </div>
            </div>
    ...
    <Label classs="ml-6 mtext-xl font-bold">More case studies</Label>
    ...
    <Images  src="https://i.postimg.cc/CKcFPp2j/Project-Cover.png" sub="Technology - SaaS" heading="Adobe Systems Inc" desc="Learn how Adobe has leveraged Webber to consolidate it’s diverse range of services software" >
    </Images></div>
    <div class="transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">
    ...
    <div class="transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">
    <Images  src="https://i.postimg.cc/QxgJyjQ9/Project-Cover-1.png" sub="Technology - SaaS" heading="Gutkowski, Schuppe and Pagac" desc="Learn how Adobe has leveraged Webber to consolidate it’s diverse range of services software">
    </Images></div>
    <div class="transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">
    ...
    <button class="place-self-center p-3 rounded-sm  bg-gradient-to-r bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 text-white ">
    ...
    export default Case_Studies_Inner;